...
const MobileNav = () => {
    return <div>
        ...
        {/*  Nav Links */}
        <div className='bg-[#0f0715] text-white fixed justify-center flex flex-col h-full w-[80%] sm:w-[60%]  space-y-6 z-[1006]'>
            ...
            {/* Close Button */}
            <CgClose className='absolute top-[1.7rem] right-[1.4rem] sm:w-8 sm:h-8 w-6 h-6 text-white'/>
        </div>
    </div>
}
